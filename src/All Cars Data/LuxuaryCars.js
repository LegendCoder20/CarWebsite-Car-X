import luxuaryCarData from "../All Cars JSON files/luxury.json";
...
function LuxuaryCars() {
  ...
  // Find the car object in luxuaryCarData that matches the route parameter
  const carData = luxuaryCarData.find((e) => e.car === car);
